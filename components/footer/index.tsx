...
export default function Footer() {
  return (
    <footer {...stylex.props(s.footerS)}>
      <div {...stylex.props(s.footerLinks)}>
        <ul {...stylex.props(s.footerUl)}>
          <li {...stylex.props(s.footerLi)}>
            <Link {...stylex.props(s.footerLink)} href="#">Terms and Conditions</Link>
          </li>
          <li {...stylex.props(s.footerLi)}>
            <Link {...stylex.props(s.footerLink)} href="#">Privacy Policy</Link>
          </li>
          <li {...stylex.props(s.footerLi)}>
            <Link {...stylex.props(s.footerLink)} href="#">Contact Us</Link>
          </li>
        </ul>
      </div>
      <div {...stylex.props(s.footerSocial)}>
        <span>Follow us</span>
        <ul {...stylex.props(s.footerSocialUl)}>
          <li {...stylex.props(s.footerSocialLi)}>
            <a href="#">
